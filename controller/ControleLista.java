        ...
        do {
            ...
            try {
                ...
                for (ListaProduto lp : associacoes) {
                    ...
                    if (p != null) {
                        produtosCompletos.add(new Pair<>(p, lp));
                    }
                }
            } catch (Exception e) {
                visaoUsuario.mostrarMensagem("Erro ao carregar produtos da lista: " + e.getMessage());
            }

            opcao = visaoLista.mostrarDetalhesLista(lista, usuarioLogado.getNome(), produtosCompletos, true).trim()
                    .toLowerCase();
    ...
    public void menuProcurarLista() {
        ...
        try {
            ...
            if (lista != null) {
                ...
                visaoLista.mostrarDetalhesLista(lista, nomeDono, produtosCompletos, false);
            } else {
    ...
    private void menuDetalhesProdutoLista(ListaProduto lp, Lista lista, Usuario usuarioLogado) {
        try {
            ...
            do {
                ...
                System.out.println("-----------------");
                System.out.println(
                        "> Início > Minhas listas > " + lista.getNome() + " > Produtos > " + produto.getNome());
                System.out.println();
                ...
                System.out.println(
                        "OBSERVAÇÕES: " + (lp.getObservacoes() == null || lp.getObservacoes().isEmpty() ? "(nenhuma)"
                                : lp.getObservacoes()));
                System.out.println();
    ...
    private void GerenciarProdutoLista(Lista lista, Usuario usuarioLogado) {
        try {
            ...
            do {
                ...
                ArrayList<ListaProduto> produtos = crudListaProduto.listarTodosListaProdutos(lista.getID(),
                        crudProduto);
